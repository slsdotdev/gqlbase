...
describe("FieldNode", () => {
  it("creates node from values", () => {
    const node = FieldNode.create("name", undefined, undefined, NamedTypeNode.create("String"));
  ...
  it("adds argument to node", () => {
    const node = FieldNode.create("name", undefined, undefined, NamedTypeNode.create("String"));
    node.addArgument(InputValueNode.create("first", undefined, undefined, "String")).addArgument({
  ...
  it("throws error when adding duplicate argument", () => {
    const node = FieldNode.create("name", undefined, undefined, NamedTypeNode.create("String"));
    const argument = InputValueNode.create("name", undefined, undefined, "String");
